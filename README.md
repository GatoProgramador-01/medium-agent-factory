...
[![Tests](https://img.shields.io/badge/tests-463-brightgreen.svg)](#test-suite)
...
**463 tests — TDD throughout (Red → Green → Refactor).**
...
| TDD throughout — 463 tests, Red → Green → Refactor, no retrofitted tests | `backend/tests/`, `frontend/src/**/*.test.tsx` |
...
<details>
<summary>Sprint History (Sprints 1 – 21)</summary>
