...
[![Tests](https://img.shields.io/badge/tests-583-brightgreen.svg)](#test-suite)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)

**18-node LangGraph pipeline that writes, evaluates, and revises Medium posts with G-Eval quality gates and eval-in-CI.**
...
**583 tests — TDD throughout (Red → Green → Refactor).**
...
| Skill | Evidence |
|-------|---------|
| LangGraph stateful multi-agent orchestration — 18 nodes, conditional edges, revision loop | `backend/app/agents/orchestrator.py` |
...
| TDD throughout — 583 tests, Red → Green → Refactor, no retrofitted tests | `backend/tests/`, `frontend/src/**/*.test.tsx` |
...
│   ├── app/
│   │   ├── agents/
│   │   │   ├── orchestrator.py                ← LangGraph pipeline — 18 nodes + conditional edges
...
<details>
<summary>Sprint History (Sprints 1 – 25)</summary>
